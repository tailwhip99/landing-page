...
function About() {
    ...
    return(
        <div className="about" id="about">
            ...
            <p className="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus ad reiciendis velit minus, nisi est error mollitia ex earum rerum!</p>
            </div>
